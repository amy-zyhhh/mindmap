...
线弹性时 $$
\begin{align}
v_{\varepsilon}=v_{c}&=\dfrac{1}{2}(\sigma_{x}\varepsilon_{x}+\sigma_{y}\varepsilon_{y}+\sigma_{z}\varepsilon_{z}+\tau_{yz}\gamma_{yz}+\tau_{zx}\gamma_{zx}+\tau_{xy}\gamma_{xy}) \\
&=\dfrac{1}{2E}[(\sigma_{x}^{2}+\sigma_{y}^{2}+\sigma_{z}^{2})-2\mu(\sigma_{y}\sigma_{z}+\sigma_{z}\sigma_{x}+\sigma_{x}\sigma_{y})+2(1+\mu)(\tau_{yz}^{2}+\tau_{zx}^{2}+\tau_{xy}^{2})] \\
&=\dfrac{E}{2(1+\mu)}[\dfrac{\mu}{1-2\mu}\theta^{2}+(\varepsilon_{x}^{2}+\varepsilon_{y}^{2}+\varepsilon_{z}^{2})+\dfrac{1}{2}(\gamma_{yz}^{2}+\gamma_{zx}^{2}+\gamma_{xy}^{2})] \\
&=\dfrac{E}{2(1+\mu)}[\dfrac{\mu}{1-2\mu}(\dfrac{ \partial u }{ \partial x } +\dfrac{ \partial v }{ \partial y } +\dfrac{ \partial w }{ \partial z } )^{2}+(\dfrac{ \partial u }{ \partial x } )^{2}+(\dfrac{ \partial v }{ \partial y } )^{2}+( \dfrac{ \partial w }{ \partial z } )^{2} \\
&\quad \quad +\dfrac{1}{2}(\dfrac{ \partial w }{ \partial y } +\dfrac{ \partial v }{ \partial z } )^{2}+\dfrac{1}{2}(\dfrac{ \partial u }{ \partial z } +\dfrac{ \partial w }{ \partial x } )^{2}+\dfrac{1}{2}(\dfrac{ \partial v }{ \partial x } +\dfrac{ \partial u }{ \partial y } )^{2}]
\end{align}
$$
$$V_{\varepsilon}=\int _{V}v_{\varepsilon} \, \mathrm{d}V,\quad V_{c}=\int _{V}v_{c} \, \mathrm{d}V$$

## 基本方程
### 位移变分方程
$$
\delta V_{\varepsilon}=\int _{V}f_{x}\delta u+f_{y}\delta v_+f_{z}\delta w \, \mathrm{d}V 
$$
