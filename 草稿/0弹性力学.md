...
\int _{V} (\varepsilon_{x}\delta\sigma_{x}+\varepsilon_{y}\delta\sigma_{y}+\sigma_{z}\varepsilon_{z}+\tau_{yz}\gamma_{yz}+\gamma_{zx}@\tau_{zx}+\gamma_{xy}\delta\tau_{xy})\, \mathrm{d}V
\end{align}
$$
