...
&\begin{cases}
\sigma_{x}=\dfrac{ \partial^{2} \psi }{ \partial x^{2} } ,\sigma_{y}=\dfrac{ \partial^{2} \psi }{ \partial y^{2} } ,\quad \sigma_{z}=\dfrac{ \partial^{2} \psi }{ \partial z^{2} }  \\
\tau_{yx}=\dfrac{ \partial^{2} \psi }{ \partial y \partial z }, 
\end{cases}
\end{align}
$$
