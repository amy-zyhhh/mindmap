...
\dfrac{ \partial  }{ \partial y } (-\dfrac{ \partial \gamma_{zx} }{ \partial y }+\dfrac{ \partial \gamma_{xy} }{ \partial y } +\dfrac{ \partial \gamma_{xy} }{ \partial z }  )=2\dfrac{ \partial^{2} \varepsilon_{x} }{ \partial y\partial z } 
\end{cases}
$$
