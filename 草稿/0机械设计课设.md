...
$T_{1}=30.944$
- 接触疲劳强度
$d\geq 75.6\cdot \sqrt[3]{ \dfrac{KT_{1}}{\psi_{d}[\sigma]_{H}^{2} }\cdot \dfrac{u+1}{u}}=31.513mm,\quad m=\dfrac{d}{z}=1.323$
- 齿根弯曲疲劳强度
$\dfrac{Y_{FS 1}}{[\sigma]_{F 1}}=\dfrac{4.41}{309}=0.01427, \dfrac{Y_{FS 4}}{[\sigma]_{F 4}}=\dfrac{4.00}{419}=0.00957$
$m\geq 1.26\cdot \sqrt[3]{ \dfrac{KT_{2}Y_{FS}}{\psi_{d}z_{3}^{2}[\sigma]_{F}} }=2.798$
- 确定尺寸
$$
\begin{align}
